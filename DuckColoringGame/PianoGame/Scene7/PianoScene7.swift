...
class PianoScene7: SKScene, AVAudioPlayerDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        let instructionPath = Bundle.main.path(forResource: "find the giraffe", ofType:"wav")!
        let correctPath = Bundle.main.path(forResource: "melody 2", ofType:".wav")!
    ...
    func audioPlayerDidFinishPlaying(_ player: AVAudioPlayer, successfully flag: Bool) {
        ...
        if player == correctAudio{
            let nextScene = SKScene(fileNamed: "PianoScene8")
